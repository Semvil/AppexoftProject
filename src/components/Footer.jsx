  ...
  return (
    <div className="max-w-[1240px] bg-black w-full py-16 px-4 mx-auto grid lg:grid-cols-3 gap-8 text-grey">
      <div className="text-white">
        <h1 className="w-full text-[30px] text-[#00DF9A] font-bold">REACT.</h1>
        <p className="py-[16px]">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed tenetur
          sunt repudiandae possimus voluptates doloremque deserunt, qui sapiente
          inventore quis. Sequi eligendi assumenda doloremque optio quos dolorum
          eaque officiis odio?
        </p>
